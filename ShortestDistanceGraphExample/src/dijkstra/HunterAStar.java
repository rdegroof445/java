...
public class HunterAStar {
	...
	public static HunterAStar x = null;
	...
	public HunterAStar(int initNumberOfNodes, int numberOfRows, int numberOfColumns, Node goalNode) {
		
		if(goalNode != null) {
			
			HunterAStar.goalNode = new Node(goalNode);
	...
	public static void main(String[] args) {
		...
		Utilities.setHunterAStarDistanceMatrix(displayGrid, x);
